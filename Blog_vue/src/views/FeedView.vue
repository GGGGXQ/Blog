    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-2 space-y-4">
            <div class="bg-white boder border-gray-200 rounded-lg">
                <div class="p-4">
                    <textarea class="p-4 w-full bg-gray-100 rounded-lg" placeholder="此刻在想什么"></textarea>
                </div>

                <div class="p-4 border-t border-gray-100 flex justify-between">
                    <a href="#" class="inline-block py-4 px-6 bg-gray-600 text-white rounded-lg">附加照片</a>
                    <a href="#" class="inline-block py-4 px-6 bg-purple-600 text-white rounded-lg">发布</a>
                </div>
            </div>

            <div class="p-4 bg-white boder border-gray-200 rounded-lg">
                <div class="mb-2 flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        <img src="../assets/virtual_img.jpg" class="w-[40px] rounded-full">
                        <p><strong>G.</strong></p>
                    </div>
                    <p class="text-gray-600">18分钟前</p>
                </div>

                <img src="../assets/virtual_blog.png" class="w-full rounded-lg">
